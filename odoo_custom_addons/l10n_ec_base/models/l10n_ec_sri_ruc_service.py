        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data and isinstance(data, list) and len(data) > 0:
                    ...
                    _logger.info(f"RUC {ruc} encontrado: {result['data'].get('razon_social')}")
                    return result
                else:
                    return {
                        'success': False,
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data and isinstance(data, list) and len(data) > 0:
                    ...
                    resultados = [self._parse_sri_response(c) for c in data[:20]]  # Limitar a 20

                    _logger.info(f"Encontrados {len(resultados)} contribuyentes para '{nombre}'")
                    return {
                        'success': True,
