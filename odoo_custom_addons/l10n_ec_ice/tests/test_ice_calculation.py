...
class TestICECalculation(TransactionCase):
    ...
    def test_ice_specific_content_alcohol(self):
        ...
        """
        taxes = self.tax_ice_alcohol.compute_all(price_unit=50.0, quantity=10, product=self.product_whisky)
    ...
    def test_ice_missing_content_default(self):
        ...
        taxes = self.tax_ice_alcohol.compute_all(price_unit=100.0, quantity=1, product=product_simple)
