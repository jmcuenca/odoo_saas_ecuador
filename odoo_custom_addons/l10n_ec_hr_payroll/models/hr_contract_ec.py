...
class HrContract(models.Model):
    ...
    l10n_ec_accumulate_reserve = fields.Boolean(
        "Accumulate Reserve Funds", default=True
    )

    # SRI Projections
    l10n_ec_projected_expenses = fields.Float(
        "Projected Personal Expenses (SRI Encuesta)"
    )
