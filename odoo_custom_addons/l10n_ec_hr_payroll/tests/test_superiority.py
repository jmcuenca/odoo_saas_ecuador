...
class TestSuperiorityFeatures(TransactionCase):
    ...
    def test_auto_overtime_calculation(self):
        ...
        self.assertAlmostEqual(payslip.overtime_hours, 2.0, msg="Should have 2.0 hours of 50% OT from weekday")

        # Weekend: 4h total -> All 4h are 100%
        # Note: In our model, 'supplementary_hours' field label is "Supplementary (100%) Hours"
        self.assertAlmostEqual(payslip.supplementary_hours, 4.0, msg="Should have 4.0 hours of 100% OT from weekend")
